package com.gmail.nguyenkimngan190920.exercise2_menuexample
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ghBar = findViewById<SeekBar>(R.id.ghSeekbar)
        ...
        ghBar.setOnSeekBarChangeListener(object:SeekBar.OnSeekBarChangeListener{
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                val twTextView = findViewById<TextView>(R.id.ghTextView)
                twTextView.text = progress.toString() + "%"
            }
            override fun onStartTrackingTouch(seekBar: SeekBar?) {}
            override fun onStopTrackingTouch(seekBar: SeekBar?) {}
